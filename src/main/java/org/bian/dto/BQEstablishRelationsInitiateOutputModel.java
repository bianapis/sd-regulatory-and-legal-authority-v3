...
/**
 * BQEstablishRelationsInitiateOutputModel
 */
public class BQEstablishRelationsInitiateOutputModel   {
  private String establishRelationsInstanceReference = null;

  private String establishRelationsInitiateActionReference = null;

  private Object establishRelationsInitiateActionRecord = null;

  private String establishRelationsInstanceStatus = null;
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to the Establish Relations instance 
   * @return establishRelationsInstanceReference
  **/

  public String getEstablishRelationsInstanceReference() {
    return establishRelationsInstanceReference;
  }

  public void setEstablishRelationsInstanceReference(String establishRelationsInstanceReference) {
    this.establishRelationsInstanceReference = establishRelationsInstanceReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to an Initiate service call 
   * @return establishRelationsInitiateActionReference
  **/

  public String getEstablishRelationsInitiateActionReference() {
    return establishRelationsInitiateActionReference;
  }

  public void setEstablishRelationsInitiateActionReference(String establishRelationsInitiateActionReference) {
    this.establishRelationsInitiateActionReference = establishRelationsInitiateActionReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The status of the Establish Relations instance (e.g. initialised, pending, active) 
   * @return establishRelationsInstanceStatus
  **/

  public String getEstablishRelationsInstanceStatus() {
    return establishRelationsInstanceStatus;
  }

  public void setEstablishRelationsInstanceStatus(String establishRelationsInstanceStatus) {
    this.establishRelationsInstanceStatus = establishRelationsInstanceStatus;
  }
